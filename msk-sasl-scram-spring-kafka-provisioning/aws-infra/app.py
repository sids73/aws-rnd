...
from aws_infra.saslscram_msk_stack import MskWithSaslScramAuthStack

from aws_apps.spring_scram_auth_stack import SpringScramAuthStack
...
public_saslscram_msk = MskWithSaslScramAuthStack(app, 'SaslScramMskStack', vpc=network_stack.vpc, env=env)

fargate_stack = FargateStack(app, 'FargateStack', vpc=network_stack.vpc, env=env, cluster_name='msk-demo')

SpringScramAuthStack(app, 'SpringScramAuthStack', fargate=fargate_stack.cluster, env=env)
