...
from aws_infra.expanding_brokers_msk_stack import MskClusterExpansionStack
...
msk = MskClusterExpansionStack(app, 'MskClusterExpansionStack', vpc=network_stack.vpc, env=env)
