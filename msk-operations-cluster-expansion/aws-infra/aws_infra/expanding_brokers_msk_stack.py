...
class MskClusterExpansionStack(Stack):

    def __init__(self, scope: Construct, construct_id: str, vpc: ec2.Vpc, cluster_name='ExpandingClusterExample', brokers=4, **kwargs) -> None:
