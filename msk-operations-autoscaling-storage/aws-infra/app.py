...
from aws_infra.autoscaling_storage_msk_stack import MskStorageAutoscalingStack
...
private_iam_msk = MskStorageAutoscalingStack(app, 'MskStorageAutoscalingStack', vpc=network_stack.vpc, env=env)
