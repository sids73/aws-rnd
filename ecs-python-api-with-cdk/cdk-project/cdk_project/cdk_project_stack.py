        ...
        if not src_path.exists():
            ...
            service = ecs_patterns.ApplicationLoadBalancedFargateService(
                ...
                task_image_options=
                    ...
                    task_subnets=ec2.SubnetSelection(subnet_type=ec2.SubnetType.PRIVATE_WITH_EGRESS) # Private subnets with internet access
                    ,desired_count=2 # 2 tasks running at all times
            )
